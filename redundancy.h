...
typedef struct pthread_redundancy{
  ...
  voter_t voters [CONFIGURE_REDUNDANCY_MAXIMUM_VOTING];
  void*      arg;
...
extern int pthread_redundancy_init(struct pthread_redundancy* r, struct pthread_redundancy_attr a, voter_t v [], void* arg);
